...
public class BaseException extends RuntimeException{
    ...
    protected ResResponseBase resObj;
    ...
    public BaseException(String code, String msg, ResResponseBase resObj) {
        super(msg);
        this.code = code;
        this.msg = msg;
        this.resObj = resObj;
    ...
    public void setResObj(ResResponseBase resObj) {
        this.resObj = resObj;
    }
    ...
    public ResResponseBase getResObj() {
        return resObj;
    }
